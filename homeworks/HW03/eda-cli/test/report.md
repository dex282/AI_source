...
- Постоянные колонки: **0** ()
- Колонки с нулями: **4** (purchases_last_30d, revenue_last_30d, churned, n_support_tickets)

## Параметры анализа

- Макс. число колонок для гистограмм: **5**
- Top-K категорий: **10**
- Порог проблемных колонок по пропускам: **10.0%**
